...
class QuestionsController < ApplicationController
  ...
  def search
    ...
    @pagy, @questions = pagy(@questions_search_form.search.with_attached_image.includes(departments: :university, questions_departments_mediators: :department), link_extra: 'data-remote="true"')
    @question_id_to_answer_id_hash_of_user = current_user&.question_id_to_answer_id_hash
